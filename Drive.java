...
public void gyroDriveWithSpeed(double Speed, double Angle_error, double Angle_rate) {       
	double Kp = 0.65; //Proportional gain 0.65
...
public double findGyroRate(){        
 ...
 public void testDrive(double speed){
	 speedControllerGroup1.set(speed);
	 speedControllerGroup2.set(-speed);
 }
 
 public void driveForwardLeft(){
	 speedControllerGroup1.set(-0.2);
	// speedControllerGroup2.set(0.3);
 } 
